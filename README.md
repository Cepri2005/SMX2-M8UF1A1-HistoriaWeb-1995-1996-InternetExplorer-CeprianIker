...
Posteriormente este pasaria a la version 1.5 que fue lanzada unos meses despues para Windows NT y con ello se le agrego un soporte para presentaciones basicas con tablas 
Pero al permitirse que el Sistema Operativo trajera consigo de forma gratuita el navegador web para evitar pagar a Spyglas inc acabo en demanda y una compensacion economica de millones de dolares 
